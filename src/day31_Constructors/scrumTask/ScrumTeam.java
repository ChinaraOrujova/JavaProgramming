...
public class ScrumTeam {
    ...
    public void removeTester(int employerID){
        testersList.removeIf(p->p.employerID==employerID);
    }
    public void removeDevelopers(int employerID){
        developersList.removeIf(p->p.employerID==employerID);
